...
int CalculatePercentage(int imarks,int iTotal)
{
    ...
    if((imarks<0) || (iTotal<0)  || (imarks>iTotal)   )        //filter clubbing
    {
        printf("invalid number\n");
        
    }
                 //filter dene mahnatat yala karan koni 150marks aani 100 outof dila tar 150 percentage hota its invalid so needed
...
int main()
{
   auto int ivalue1=0;
    ...
    return 0;
}           //||logical or operator arth kiva
            //&& and and operator aani condition sathi